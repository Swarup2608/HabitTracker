...
const INJECTED_STYLES = `
  ...
  .earth-clouds {
      ...
      display: flex;
      animation: earth-roll 12s linear infinite;
      opacity: 1;
  }
  .earth-clouds > svg { width: 50%; height: 100%; flex: 0 0 50%; }
  @keyframes earth-roll {
      from { transform: translateX(0); }
      to { transform: translateX(-50%); }
  }
    ...
    >
      ...
      <div ref={loaderRef} className="opening-loader" aria-hidden="true">
        <div className="relative flex flex-col items-center gap-8">
          ...
          <span className="opening-loader-label uppercase">Tally</span>
        </div>
      </div>
